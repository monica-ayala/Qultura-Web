...
const event_controller = require('../controllers/museo_controller');

router.get('/',museo_controller.lista);
router.get('/get',museo_controller.get_museo);
router.get('/nuevo_evento',museo_controller.get_nuevo)
router.post('/nuevo_evento',museo_controller.museo_post)
